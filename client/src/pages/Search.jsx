...
function Search({
    ...
    function handleSearch() {
        ...
        axios.get(`${ process.env.APP_API_URL || 'http://localhost:8080' }/search-recipes`, { params: { userId: user.userId, searchQuery, filters, sort: user.accountType === "user" ? { createdAt: -1 } : { flagCount: 1 } } })
            .then(res => {
