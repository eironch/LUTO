...
function Auth(p) {
    ...
    function signUp() {
        axios.post(`${ process.env.REACT_APP_API_URL || 'http://172.20.10.3:8080' }/sign-up`, { username: user.username, password, email })
            .then(res => {
    ...
    function signIn() {
        axios.get(`${ process.env.REACT_APP_API_URL || 'http://172.20.10.3:8080' }/sign-in`, { params: { username: user.username, password }, withCredentials: true })
            .then(res => {
                console.log('Status Code:' , res.status)
                console.log('Data:', res.data)
    ...
    function checkAvailability() {
        axios.get(`${ process.env.REACT_APP_API_URL || 'http://172.20.10.3:8080' }/check-availability`, { params: { username: user.username, email } })
            .then(res => {
                console.log('Status Code:' , res.status)
                console.log('Data:', res.data)
    ...
    function sendVerificationCode() {
        axios.post(`${ process.env.REACT_APP_API_URL || 'http://172.20.10.3:8080' }/send-verification`, { email: email })
            .then(res => {
                console.log('Status Code:' , res.status)
                console.log('Data:', res.data)
            })
    ...
    function verifyCode() {
        ...
        axios.get(`${ process.env.REACT_APP_API_URL || 'http://172.20.10.3:8080' }/verify-code`, { params: { email: email, code: verifyInputUses.map(use => use.state[0]).join('') } })
            .then(res => {
                console.log('Status Code:' , res.status)
                console.log('Data:', res.data)
