...
function App() {
  ...
  async function handleGiveRecipePoint(userId, recipeId, pointStatus) {
    return await axios.post(`${ process.env.APP_API_URL || 'http://localhost:8080' }/give-point`, { userId, recipeId, pointStatus })
      .then(res => {
  ...
  function handleFlagRecipe(userId, recipeId) {
    axios.post(`${ process.env.APP_API_URL || 'http://localhost:8080' }/flag-recipe`, { userId, recipeId })
      .then(res => {
        console.log('Status Code:' , res.status)
        console.log('Data:', res.data)
      })
  ...
  function handleRemoveRecipe(removerUserId, recipeId) {
    axios.post(`${ process.env.APP_API_URL || 'http://localhost:8080' }/remove-recipe`, { removerUserId, recipeId })
      .then(res => {
        console.log('Status Code:' , res.status)
        console.log('Data:', res.data)
      })
  ...
  function handleAllowRecipe(recipeId) {
    axios.post(`${ process.env.APP_API_URL || 'http://localhost:8080' }/allow-recipe`, { recipeId })
      .then(res => {
        console.log('Status Code:' , res.status)
        console.log('Data:', res.data)
      })
  ...
  function handleLogOut() {
    axios.get(`${ process.env.APP_API_URL || 'http://localhost:8080' }/log-out`, { withCredentials: true })
      .then(res => {
        console.log('Status Code:' , res.status)
        console.log('Data:', res.data)
  ...
  function handleSaveFilters(user) {
    axios.post(`${ process.env.APP_API_URL || 'http://localhost:8080' }/save-filters`, { userId: user.userId , filters })
      .then(res => {
        console.log('Status Code:' , res.status)
        console.log('Data:', res.data)
      })
  ...
  function handleGetPreferences(userId) {
    axios.get(`${ process.env.APP_API_URL || 'http://localhost:8080' }/get-preferences`, { params: { userId } })
      .then(res => {
        console.log('Status Code:' , res.status)
        console.log('Data:', res.data)
